...
(function () {
    ...
    // § B — GLOBAL STATE
    // =====================================================================
    const DEFAULT_COVER = 'https://images.unsplash.com/photo-1493225457124-a1a2a5f56468?auto=format&fit=crop&q=80&w=400';
    ...
    if (!playlist.length) {
        playlist = [{ id:'default_1', title:'Miku Theme', artist:'Hatsune Miku', cover:'https://images.unsplash.com/photo-1614613535308-eb5fbd3d2c17?auto=format&fit=crop&q=80&w=400', src:'https://files.catbox.moe/jaknuq.mp3', type:'url' }];
    }
    ...
    function highlightNav(url) {
        const page = url.split('/').pop().split('#')[0] || 'dashboard.html';
